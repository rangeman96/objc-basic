...
- (void)viewDidLoad {
    ...
    //iPhoneSE
    if([deviceName isEqual:@"iPhoneSE"]) {
        ...
        //iPhone8
    } else if ([deviceName isEqual:@"iPhone8"]) {
        ...
        //iPhone8 plus
    } else if ([deviceName isEqual:@"iPhone8plus"]) {
...
- (void)setupPrevCalendarData {
    ...
    NSDateComponents *prevComps = [NSDateComponents new];
...
- (void)setupNextCalendarData {
    ...
    NSDateComponents *nextComps = [NSDateComponents new];
